...
ti_grid_mine = ti.Vector.field(3, ti.f32, shape=(grid_res, grid_res, grid_res))
ti_grid_neighbor = ti.Vector.field(3, ti.f32, shape=(grid_res, grid_res, grid_res))
ti_grid_mine_denominator = ti.field(ti.f32, shape=(grid_res, grid_res, grid_res))
ti_grid_other_denominator= ti.field(ti.f32, shape=(grid_res, grid_res, grid_res))
##########################################
